        ...
        <div class="homeblog_wrapper{if isset($tc_config.YBC_TC_ENABLE_SPECIAL) && $tc_config.YBC_TC_ENABLE_SPECIAL == 1} col-sm-12 col-md-6 col-lg-6 custom_blog_half_width{else} custom_blog_full_width col-sm-12 col-xs-12{/if}">
            <div class="block ybc_block_latest {$blog_config.YBC_BLOG_RTL_CLASS|escape:'html':'UTF-8'} {if isset($page) && $page}page_{$page|escape:'html':'UTF-8'}{else}page_blog{/if} {if isset($page) && $page=='home'}{if isset($blog_config.YBC_BLOG_HOME_POST_TYPE) && $blog_config.YBC_BLOG_HOME_POST_TYPE=='default' || count($posts)<=1}ybc_block_default{else}ybc_block_slider{/if}{else}{if isset($blog_config.YBC_BLOG_SIDEBAR_POST_TYPE) && $blog_config.YBC_BLOG_SIDEBAR_POST_TYPE=='default' || count($posts)<=1}ybc_block_default{else}ybc_block_slider{/if}{/if}">
                <h3 class="h1 products-section-title text-uppercase">
                    <span>{l s='Latest from blog' mod='ybc_blog'}</span>
                </h3>
                        ...
                        {assign var='is' value=$is+1}
                            <div class="ybc_block_latest_item">
                                ...
                                <div class="ybc-blog-latest-post-content">
                                    ...
                                    {/if}
                                    <a class="read_more" href="{$post.link|escape:'html':'UTF-8'}">{l s='Read more ' mod='ybc_blog'}<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        {if $is%2 == 0}
                            </div>
        ...
        {else}
            <div class="block ybc_block_latest {$blog_config.YBC_BLOG_RTL_CLASS|escape:'html':'UTF-8'} {if isset($page) && $page}page_{$page|escape:'html':'UTF-8'}{else}page_blog{/if} {if isset($page) && $page=='home'}{if isset($blog_config.YBC_BLOG_HOME_POST_TYPE) && $blog_config.YBC_BLOG_HOME_POST_TYPE=='default' || count($posts)<=1}ybc_block_default{else}ybc_block_slider{/if}{else}{if isset($blog_config.YBC_BLOG_SIDEBAR_POST_TYPE) && $blog_config.YBC_BLOG_SIDEBAR_POST_TYPE=='default' || count($posts)<=1}ybc_block_default{else}ybc_block_slider{/if}{/if}">
                <h1 class="h1 products-section-title text-uppercase">
                    <span>{l s='Latest posts' mod='ybc_blog'}</span>
                </h1>
