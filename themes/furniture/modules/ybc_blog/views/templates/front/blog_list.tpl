        ...
        <div class="container">
          <div class="row">
              ...
              {block name="content_wrapper"}
                <div id="content-wrapper" class="{if isset($blog_config.YBC_BLOG_SIDEBAR_POSITION) && $blog_config.YBC_BLOG_SIDEBAR_POSITION=='left'}left-column col-xs-12 col-sm-8 col-md-8 col-lg-9{elseif isset($blog_config.YBC_BLOG_SIDEBAR_POSITION) && $blog_config.YBC_BLOG_SIDEBAR_POSITION=='right'}right-column col-xs-12 col-sm-8 col-md-8 col-lg-9{/if}">
                  {block name="content"}
                    <div class="ybc_blog_layout_{$blog_layout|escape:'html':'UTF-8'} ybc-blog-wrapper ybc-blog-wrapper-blog-list {if $blog_latest}ybc-page-latest{elseif $blog_category}ybc-page-category{elseif $blog_tag}ybc-page-tag{elseif $blog_search}ybc-page-search{elseif $author}ybc-page-author{else}ybc-page-home{/if}">
                        {if $is_main_page}
                        ...
                        {elseif $blog_search}
                            <h1 class="page-heading product-listing">{l s='Search: ' mod='ybc_blog'}"{ucfirst($blog_search)|escape:'html':'UTF-8'}"</h1>
                        {elseif $author}
                                                ...
                                                <div class="ybc-blog-wrapper-content-main">
                                                    ...
                                                    {if $show_date || $show_categories && $post.categories}
                                                        <div class="ybc-blog-sidear-post-meta"> 
                                                            ...
                                                            {/if}
                                                            {if $show_date}                                
                                                                <span class="post-date">{l s='Posted on' mod='ybc_blog'} <span>{if isset($blog_config.YBC_BLOG_DATE_FORMAT)&&$blog_config.YBC_BLOG_DATE_FORMAT}{date($blog_config.YBC_BLOG_DATE_FORMAT, strtotime($post.datetime_added))|escape:'html':'UTF-8'}{else}{date('F jS Y', strtotime($post.datetime_added))|escape:'html':'UTF-8'}{/if}</span></span>                              
                                                            {/if} 
                                                        </div> 
                                                    {/if}
                                                    ...
                                                    <a class="read_more" href="{$post.link|escape:'html':'UTF-8'}">{l s='Read More' mod='ybc_blog'}</a>
                                                  </div>
                                                </div>
                                            </div>
