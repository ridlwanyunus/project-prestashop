...
<script type="text/javascript">
    ybc_blog_report_url = '{$report_url|escape:'html':'UTF-8'}';
        ...
        <div class="post-details">
            <div class="blog-extra">
                <div class="ybc-blog-latest-toolbar">
                    ...
                    {/if} 
                    {if $allow_like}
                        <span title="{if $likedPost}{l s='Liked' mod='ybc_blog'}{else}{l s='Like this post' mod='ybc_blog'}{/if}" class="ybc-blog-like-span ybc-blog-like-span-{$blog_post.id_post|intval} {if $likedPost}active{/if}"  data-id-post="{$blog_post.id_post|intval}">
                ...
                {if $use_google_share || $use_facebook_share || $use_twitter_share}
                    <div class="blog-extra-item blog-extra-facebook-share">
                        ...
                        {if $use_twitter_share}
                            <div class="ybc_blog_button_share">
                                <a href="https://twitter.com/share" class="twitter-share-button" data-url="{$post_url|escape:'html':'UTF-8'}">{l s='Tweet' mod='ybc_blog'}</a>
                                {literal}
                        ...
                        <ul class="blog-comments-list">
                            {foreach from=$comments item='comment'}
                                    ...
                                    <div class="ybc-blog-detail-comment">
                                        ...
                                        {if $comment.firstname || $comment.lastname}<span class="comment-by">{l s='By : ' mod='ybc_blog'}<b>{ucfirst($comment.firstname)|escape:'html':'UTF-8'} {ucfirst($comment.lastname)|escape:'html':'UTF-8'}</b></span>{/if}
                                        ...
                                        {if $allow_report_comment && $hasLoggedIn}
                                            {if !($reportedComments && is_array($reportedComments) && in_array($comment.id_comment, $reportedComments))}
                                                <span class="ybc-block-comment-report comment-report-{$comment.id_comment|intval}" rel="{$comment.id_comment|intval}">{l s='Report abuse' mod='ybc_blog'}</span>
                                            {/if}
                                        {/if}
