        ...
        <div class="product_special_img">
            <div class="table table_img">
                <div class="table-cell">
                    ...
                    <div id="ets_clock_{$product.id_product|intval}" data-id-product="{$product.id_product|intval}" data-date-to="{if isset($product.specific_prices.to)}{$product.specific_prices.to}{/if}" class="ets_clock"></div>
                </div>
            </div>
        </div>
      {/block}
