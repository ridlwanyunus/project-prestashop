                                                ...
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        {if isset($row.view_url) && $row.view_url}
                                                            <li><a target="_blank" href="{$row.view_url|escape:'html':'UTF-8'}"><i class="icon-search-plus"></i> {if isset($row.view_text) && $row.view_text} {$row.view_text|escape:'html':'UTF-8'}{else} {l s='Preview' mod='ybc_blog'}{/if}</a></li>
                                                            <li class="divider"></li>
                                                        {/if}
